; TurboBadgerUI Plugin Installer
...
Name "TurboBadgerUI Plugin ${VERSION} for CryEngine"

; The file to write
OutFile "Plugin_TurboBadgerUI_${VERSION}.exe"
...
; Sections
Section "TurboBadgerUI" SEC_PLUGIN
    SectionIn RO
        
    SetOutPath "$INSTDIR\Bin32\Plugins\TurboBadgerUI"
    ;File "${FILES_ROOT}\..\..\Bin32\Plugins\TurboBadgerUI\Plugin_TurboBadgerUI.dll"
	File "${FILES_ROOT}\..\..\Bin32\Plugins\TurboBadgerUI\*.dll"

    SetOutPath "$INSTDIR\Bin64\Plugins\TurboBadgerUI"
    ;File "${FILES_ROOT}\..\..\Bin64\Plugins\TurboBadgerUI\Plugin_TurboBadgerUI.dll"
    File "${FILES_ROOT}\..\..\Bin64\Plugins\TurboBadgerUI\*.dll"

	; Standard Code directory also used in git repo
    SetOutPath "$INSTDIR\Code\Plugin_TurboBadgerUI"
...
Section "Interface Headers" SEC_INTERFACE
    SetOutPath "$INSTDIR\Code\Plugin_TurboBadgerUI\inc"
...
; Set Fileinfos
VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductName" "TurboBadgerUI Plugin"
VIAddVersionKey /LANG=${LANG_ENGLISH} "LegalCopyright" "Copyright (c) 2016, The authors of the TurboBadgerUI Plugin project"
VIAddVersionKey /LANG=${LANG_ENGLISH} "FileDescription" "TurboBadgerUI Plugin for CryEngine"
...
Function "ShowChangelog"
	Exec 'notepad "$INSTDIR\Code\Plugin_TurboBadgerUI\changelog.md"'
FunctionEnd
